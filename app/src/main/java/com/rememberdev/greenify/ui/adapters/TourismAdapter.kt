...
import com.rememberdev.greenify.databinding.ItemTourismByCategoryBinding
...
class TourismAdapter(private val listAllTourism: ArrayList<DataItem>) :
    RecyclerView.Adapter<TourismAdapter.ListViewHolder>() {

    class ListViewHolder(var binding: ItemTourismByCategoryBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TourismAdapter.ListViewHolder {
        val binding = ItemTourismByCategoryBinding.inflate(LayoutInflater.from(parent.context), parent, false)
